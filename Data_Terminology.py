Data wrangling (synonymous with data cleaning) is used to transform structured or semi-structure datasets from one form into another.
    ...
    collapsing or truncating overly complex data into a more compact form